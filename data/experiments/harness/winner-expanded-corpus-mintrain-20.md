...
- Generated: `2026-05-13T00:23:00.009851+00:00`
- Config: `configs/experiments/winner-expanded-corpus-mintrain-20.json`
- Value status: `research_only`
- Writes `model_versions`: `false`
- Model-eligible events: 49
- Model-eligible fights: 462

## Ranking

| Rank | Variant | ROI delta vs market | Log-loss delta | Brier delta | Clears gate | Rejection reasons |
|---:|---|---:|---:|---:|---|---|
| 1 | log_allmarketctx_c2p5_temp2p2_blend45_min_confidence0p63 | +2.7% | -0.0126 | -0.0062 | true |  |
...
|---|---|---|---:|---:|---:|---:|---:|---:|
| market_favorite | market_favorite | none |  | 462 | 74.7% | 0.5742 | 0.1942 | 18.6% |
| log_allmarketctx_c2p5_temp2p2_blend45_min_confidence0p63 | logistic_regression | production_plus_all_research_market_context | 0.45 | 268 | 77.6% | 0.5290 | 0.1735 | 19.6% |
