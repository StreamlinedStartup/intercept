...
const weights = Array.from({ length: 33 }, (_, index) => Number(((index * 3 + 1) / 100).toFixed(2)));

const families = [
  ["xgb_prod", "xgboost", "production", "XGBoost production features"],
  ["xgb_avail", "xgboost", "production_plus_availability", "XGBoost with feature availability indicators"],
  ["log_prod", "logistic_regression", "production", "regularized logistic regression production features"],
];
